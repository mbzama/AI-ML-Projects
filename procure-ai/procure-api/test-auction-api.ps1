...
try {
    ...
    Write-Host "   OK Auction created successfully!" -ForegroundColor Green
    ...
    Write-Host "   OK Line item 1 added successfully!" -ForegroundColor Green
    ...
    Write-Host "   OK Line item 2 added successfully!" -ForegroundColor Green
    ...
    Write-Host "   OK Retrieved $($allAuctions.Count) auction(s)" -ForegroundColor Green
    ...
    Write-Host "   OK Retrieved specific auction: $($specificAuction.title)" -ForegroundColor Green
    ...
    Write-Host "   OK Auction published successfully!" -ForegroundColor Green
    ...
    Write-Host "   OK Auction status: $($verifyAuction.status)" -ForegroundColor Green
    
    Write-Host "`nSUCCESS All auction creation tests passed!" -ForegroundColor Green
...
Write-Host "`nYou can also test the UI at: http://localhost:8080/api/create-auction" -ForegroundColor Magenta
